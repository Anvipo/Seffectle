...
class ScheduleActionsActivity : AppCompatActivity() {
    ...
    private val scheduleAdapter by lazy(LazyThreadSafetyMode.NONE) {
        ScheduleAdapter(
            mutableListOf(*classesFromDB.map { it to false }.toTypedArray()),
        ...
        when (item.itemId) {
            ...
            R.id.action_save_schedule -> {
                ...
                for (i in 0 until scheduleAdapter.itemCount) {
                    ...
                    val classBeginTime = classData.class_begin_time
                    ...
                    val classEndTime = classData.class_end_time
                    ...
                    tempClassesList.add(
                        arrayOf(
                            ...
                            KEY_CLASS_TYPE to classData.class_type,
                            KEY_CLASS_NAME to classData.class_name,
                            KEY_TEACHER_NAME to classData.teacher_name,
                            KEY_ROOM_NAME to classData.room_name,
                            KEY_CLASS_SERIAL_NUMBER to classData.class_serial_number,
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private fun isOverlappingJava8(
        startA: LocalTime,
        endA: LocalTime,
        startB: LocalTime,
        endB: LocalTime
